...
class GoogleDriveController extends Controller
{
    ...
    function __construct(){
        ...
        $this->gClient->setClientId('995500127796-nh965nau5toj9npdgaoj0d6b3283oh6i.apps.googleusercontent.com');
        $this->gClient->setClientSecret('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');
        $this->gClient->setRedirectUri(route('google.login'));
        $this->gClient->setDeveloperKey('AIzaSyD7SFnSqCzGtmMNeaGhP0R1yzzfgB5PfLM');
